...
public class OpmMod {
    ...
    public static final DeferredHolder<Item, Item> EXAMPLE_ITEM = ITEMS.register("example_item", () -> new Item(new Item.Properties().food(new FoodProperties.Builder().alwaysEat().nutrition(1).saturationMod(2f).build())));
    ...
    public OpmMod(IEventBus modEventBus, ModContainer modContainer) {
        ...
        // Register our mod's config if it exists
