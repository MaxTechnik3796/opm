...
public final class RecipeJsonBuilder {
    ...
    public static String buildMechCrafting(List<ItemStack> grid, int gridW, int gridH,
        ...
        String sym = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789"
                + "#@$%&*+-/:;<=>?^_{}|~!.,()[]";
        return buildPatternBased("create:mechanical_crafting", grid, gridW, gridH,
                result, count, sym, true, acceptMirrored);
    }

    /** Sdílený builder pro shaped a mechanical_crafting. */
    private static String buildPatternBased(String type, List<ItemStack> grid, int gridW, int gridH,
                                            ItemStack result, int count, String symbols,
                                            boolean keyBeforePattern, boolean acceptMirrored) {
    ...
    public static String buildFurnace(String subType, ItemStack input, ItemStack result,
                                      int count, int cookTime, float xp) {
        return "{\n" +
    ...
    public static String id(ItemStack stack) {
        ...
        if (stack.getItem() == net.minecraft.world.item.Items.NAME_TAG
