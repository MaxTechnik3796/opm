...
public class StationLayout{
	...
	public ToggleGroup getHeaderToggle(){
		return headerToggle;
	}
	public ToggleGroup getSubToggle(){
		return subToggle;
	}
	public SlotGroup getInputSlots(){
		return inputSlots;
	}
	public SlotGroup getOutputSlots(){
		return outputSlots;
	}
	public SlotGroup getInputFluids(){
		return inputFluids;
	}
	public SlotGroup getOutputFluids(){
		return outputFluids;
	}
