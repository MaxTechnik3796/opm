...
public class OpmOverlays{
	public static final ResourceLocation ARMOR_HUD=ResourceLocation.fromNamespaceAndPath(OpmMod.MODID,"armor_hud");
	public static final ResourceLocation EFFECTS_HUD=ResourceLocation.fromNamespaceAndPath(OpmMod.MODID,"effects_hud");
	public static final ResourceLocation ITEM_DURABILITY=ResourceLocation.fromNamespaceAndPath(OpmMod.MODID,"item_durability");
	@SubscribeEvent
